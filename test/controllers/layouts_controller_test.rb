...
class LayoutsControllerTest < ActionController::TestCase
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post :create, layout: { custom_layout: @layout.custom_layout, layout_type: @layout.layout_type, name: @layout.name }
    end
  ...
  test "should update layout" do
    patch :update, id: @layout, layout: { custom_layout: @layout.custom_layout, layout_type: @layout.layout_type, name: @layout.name }
    assert_redirected_to layout_path(assigns(:layout))
  end
